...
(function(){
    ...
    Parse.initialize("CsUCJhLqIAuJUZnTEAFlmQwCnGgVDNXzzLo7tQ19", "uzmaq31I86cUtbWvjlTUWxT8yESBrgoPKqmwHdnh"); //PASTE HERE YOUR Back4App APPLICATION ID AND YOUR JavaScript KEY
    ...
    editFriendForm.addEventListener('submit', function(event){
        event.preventDefault();
        editFriendForm.className = 'editfriend-offscreen'
    })
